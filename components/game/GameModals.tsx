...
import type { AppSettings, Character, LoreRule, WorldLogicRule, WorldEvent, GalleryImage, WorldHealingReport, SupplementReport } from '../../types';
...
export const GameModals = ({
    ...
    manuallyTriggerWorldHealing,
        // supplementSingleCharacter, // Xoá nếu không sử dụng
}: GameModalsProps) => {
    ...
    console.log('[DEBUG] GameModals activeModal:', activeModal);
    ...
    return (
        <>
            ...
            {/* FIX: Removed the unsupported `onRenameEntity` prop from KnowledgeBaseModal. */}
